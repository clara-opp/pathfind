# ============================================================
# pathfind_design.py - UNIFIED DARK DESIGN v18 (CLOUD-SAFE)
# PERFECT V18 LOOK + CLOUD COMPATIBLE
# ============================================================
...
def setup_complete_design():
    # CLOUD FIX 1: Remove 200% width/height (causes scroll/cut-off)
    # Keep zoom effect via scale on block-container instead
    st.markdown(
        """
    <style>
        :root {
    ...
    /* ========================================
       CLOUD FIX 2: Scale via block-container (safe)
       Instead of zoom: 80% + width 200% (breaks Cloud)
       ======================================== */
    .block-container {{
    ...
    /* CLOUD FIX 3: Remove fixed overlay (z-index: -2 bugs)
       Blur now only in the boxes themselves via backdrop-filter */
